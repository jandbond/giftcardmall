<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text style="background-color: white;">
            <Number label="PurchaseLimit" v-model="value.purchaseLimit" :editMode="editMode" :inputUI="''"/>
            <Number label="TotalLimit" v-model="value.totalLimit" :editMode="editMode" :inputUI="''"/>

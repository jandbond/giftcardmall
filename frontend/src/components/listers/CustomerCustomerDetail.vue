<template>
    <v-card outlined>
        ...
        <v-card-text>
            <div>
                <Number label="PurchaseLimit" v-model="item.purchaseLimit" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Number label="TotalLimit" v-model="item.totalLimit" :editMode="editMode" @change="change" />
            </div>
            <div>

<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text style="background-color: white;">
            ...
            <Number label="VoucherAmount" v-model="value.voucherAmount" :editMode="editMode" :inputUI="''"/>
            <Date label="CreatedAt" v-model="value.createdAt" :editMode="editMode" :inputUI="''"/>
            <Date label="UpdatedAt" v-model="value.updatedAt" :editMode="editMode" :inputUI="''"/>
        </v-card-text>
